...
let IconDirectionDownCircle: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconDirectionDownCircle = React.memo ? React.memo(IconDirectionDownCircle) : IconDirectionDownCircle;

export default IconDirectionDownCircle;
