...
let IconShujiashugui: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconShujiashugui = React.memo ? React.memo(IconShujiashugui) : IconShujiashugui;

export default IconShujiashugui;
