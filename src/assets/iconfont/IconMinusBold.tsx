...
let IconMinusBold: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconMinusBold.defaultProps = {
  size: 18,
};

IconMinusBold = React.memo ? React.memo(IconMinusBold) : IconMinusBold;

export default IconMinusBold;
