...
let IconDirectionDown: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconDirectionDown = React.memo ? React.memo(IconDirectionDown) : IconDirectionDown;

export default IconDirectionDown;
