...
const IconExport: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
export default React.memo ? React.memo(IconExport) : IconExport;
