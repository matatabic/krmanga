...
let IconDirectionUp: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconDirectionUp = React.memo ? React.memo(IconDirectionUp) : IconDirectionUp;

export default IconDirectionUp;
